...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('email', type=str, help='Email пользователя, для которого создаются записи')
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f'Успешно сгенерировано 20 записей для пользователя {email}'))
